...
public class DBGetProtocolClassForId implements DBProcedure {
	...
	{	
		try {
	        ...
	        Statement statement = conn.createStatement();
		   	String que1 = "exec GetProtocolClassForId " + pid + ";";
	    	...
	    	System.err.println("DBGetProtocolClassForId. An error has occured");
	    	e.printStackTrace();
	    	return null;
		}
	}
